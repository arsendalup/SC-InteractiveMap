...
import L from '../Lib/LeafletPlugins.js';
...
// Leaflet Selection Extensions - Initialize when called
export function initializeLeafletSelectionPlugins() {
    if (typeof window.L === 'undefined') {
        console.error('Leaflet not loaded for Selection plugins');
        return;
    }
