...
import { initializeLeafletSelectionPlugins } from './Modal/Selection.js';
...
export default class SCIM {
    constructor() {
        ...
        this.staticAssetsUrl = "https://satisfactory-calculator.com";
        this.mapDataUrl = "./static/map_gamedata.json";
        this.gameDataUrl = "/" + this.language + "/api/game";
        this.modsDataUrl = "/" + this.language + "/mods/index/json";
        this.translationDataUrl = "./static/translations.json";
        this.statisticsUrl = "/" + this.language + "/api/statistics";
        this.tetrominoUrl = "/" + this.language + "/api/tetromino";
        this.usersUrl = "/" + this.language + "/api/users";

        this.saveParserReadWorker = '/build/Worker/SaveParser/Read.js';
        this.saveParserWriteWorker = '/build/Worker/SaveParser/Write.js';
    ...
    start(remoteUrl = null) {
        ...
        Lib_LeafletPlugins.initialize();
        initializeLeafletSelectionPlugins();
