...
export default class GameMap {
    ...
    loadInitialData() {
        $.getJSON(this.dataUrl, (data) => {
            if (data !== undefined) {
                ...
                if (this.mapOptions && Array.isArray(this.mapOptions)) {
                                        ...
                                        if (option.markers[caveId].entrances !== undefined) {
                                            for (let l = 0; l < option.markers[caveId].entrances.length; l++) {
                                                ...
                                                if (haveEntranceHeight !== false) {
                                                    ...
                                                    currentEntrance.bindTooltip('<div class="d-flex" style="border: 25px solid #7f7f7f;border-image: url(https://satisfactory-calculator.com/js/InteractiveMap/img/genericTooltipBackground.png) 25 repeat;background: #7f7f7f;margin: -7px;color: #FFFFFF;text-shadow: 1px 1px 1px #000000;line-height: 16px;font-size: 12px;">\
                                ...
                                for (let l = 0; l < option.markers.length; l++) {
                                    ...
                                    if (option.layerId === 'hardDrives') {
                                        if (marker.powerNeeded !== undefined && marker.powerNeeded !== false) {
                                            ...
                                            currentMarkerOptions.extraIcon = 'https://satisfactory-calculator.com/img/bolt.png';
                                        }
                    ...
                    console.error('mapOptions is not an array or is undefined:', this.mapOptions);
                }
            }
        }).done(() => {
            // Hash Default
    ...
    showTooltip(e) {
        ...
        if (tooltip.length > 0) {
            tooltip = '<div class="d-flex" style="border: 25px solid #7f7f7f;border-image: url(https://satisfactory-calculator.com/js/InteractiveMap/img/genericTooltipBackground.png) 25 repeat;background: #7f7f7f;margin: -7px;color: #FFFFFF;text-shadow: 1px 1px 1px #000000;line-height: 16px;font-size: 12px;">\
                <div class="justify-content-center align-self-center w-100 text-center" style="margin: -10px 0;">\
                    ' + tooltip.join('') + '\
                </div>\
            </div>';
