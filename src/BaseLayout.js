...
import Lib_FactoryGenerator from './Lib/L.Control.FactoryGenerator.js';
...
export default class BaseLayout {
    ...
    addLayers(i = 0) {
        ...
        return new Promise((resolve) => {
            ...
            // Factory Generator control
            this.factoryGeneratorControl = new L.Control.FactoryGenerator({ baseLayout: this });
            this.satisfactoryMap.leafletMap.addControl(this.factoryGeneratorControl);
        });
    }
    ...
    addItemPickup(currentObject) {
        ...
        if (mPickupItems !== null && mPickupItems.values[0].value.properties[0] !== null && mPickupItems.values[0].value.properties[0].value > 0) {
            ...
            if (itemId !== null) {
                ...
                let iconImage = 'https://satisfactory-calculator.com/img/mapUnknownIcon.png';
    ...
    getItemDataFromClassName(className, debugToConsole = true) {
        ...
        let moddedItem = {
            ...
            category: 'mods',
            image: 'https://satisfactory-calculator.com/img/mapUnknownIcon.png'
        };
